        ...
        <div className='bg-white py-[7.292vw]'>
            <div className='max-w-[1400px] mx-auto my-10 lg:my-20 px-5 lg:px-5'>
                <div className="flex flex-col md:flex-row md:justify-between items-center space-y-3">
                    ...
                    <div className='w-36 h-12 bg-yellow-500 cursor-pointer text-black flex items-center justify-center rounded-full'>
                        <button className='cursor-pointer' onClick={gotoLoan}>Get loan now</button>
                    </div>
                </div>
